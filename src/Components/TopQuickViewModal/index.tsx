...
import classes from "./TopQuickViewModal.module.scss"
...
type QuickViewModalProps = {
 ...
 const TopQuickViewModal:React.FC<QuickViewModalProps> = ({active, closeModal}) => {
  const dispatch = useAppDispatch()
  const {qCard} = useSelector(selectUser)
...
export default TopQuickViewModal;